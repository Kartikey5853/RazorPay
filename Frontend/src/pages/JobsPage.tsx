        ...
        <div className="w-full pb-32">
            ...
            <div className="container pt-8">
                <div className="flex items-center gap-4 mb-6 border-b" style={{ paddingBottom: '0.25rem' }}>
                    {["Active (12)", "Completed", "Archived"].map((tab, idx) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        { id: "JOB-4091", title: "Find Lead Actor", org: "Project X Production", status: "In Progress", progress: "14/20", tag: "Review 3 shortlisted candidates", actionIcon: "auto_awesome" },
                        { id: "JOB-4088", title: "Website Development", org: "Acme Tech Solutions", status: "Pending Input", progress: "Phase 1", tag: "Collect requirements doc", actionIcon: "mail" },
                        { id: "JOB-4075", title: "Q3 Email Campaign", org: "Internal Marketing", status: "In Progress", progress: "4.2% CTR", tag: "A/B Test Subject Lines", actionIcon: "science" }
                    ].map((job) => (
                        <div key={job.id} onClick={() => navigate(`/job-detail`)} className="bg-white rounded-xl border shadow-sm flex flex-col cursor-pointer" style={{ height: '400px', transition: 'box-shadow 0.2s' }} onMouseEnter={e => e.currentTarget.style.boxShadow = '0 10px 15px -3px rgba(0, 0, 0, 0.1)'} onMouseLeave={e => e.currentTarget.style.boxShadow = '0 1px 2px 0 rgba(0, 0, 0, 0.05)'}>
                            <div className="p-6 border-b flex-1 flex flex-col">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="bg-slate-100 text-sm px-2 py-1 rounded font-mono font-bold" style={{ color: '#334155' }}>{job.id}</span>
                                ...
                                <p className="text-sm text-on-surface-variant flex items-center gap-2 mb-6">
                                    <span className="material-symbols-outlined text-sm">corporate_fare</span> {job.org}
                                </p>
                                <div className="grid grid-cols-2 gap-4 mt-auto">
                                    ...
                                    <div className="bg-slate-50 p-3 rounded-lg border">
                                        ...
                                        <div className="text-sm font-bold text-primary">₹25k</div>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 bg-slate-50 border-t" style={{ borderBottomLeftRadius: '0.75rem', borderBottomRightRadius: '0.75rem' }}>
                                ...
                                <button className="w-full flex items-center justify-between bg-secondary text-white p-3 rounded-lg shadow-sm">
                                    <div className="flex items-center gap-2">
                                        <span className="material-symbols-outlined text-sm">{job.actionIcon}</span>
                                        <span className="text-sm font-bold">{job.tag}</span>
                                    </div>
